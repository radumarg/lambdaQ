...
spec =  do
  describe "Testing Semantic Analysis:" $ do
    ...
    --   it "returns no error" $ do
    --     testProgram "test/programs/examples/example11-qft.lq" `shouldReturn` "OK"
    ...
    --     result <- testProgram "test/programs/bad/example00-CoinFlip__FunctionNamesAreNotUnique.lq"
    ...
    --   it "returns an error" $ do
    --     result <- testProgram "test/programs/bad/example08-groverAlgorithm__FunctionNamesAreNotUnique.lq"
    --     result `shouldSatisfy` (\str -> "Function name is not unique" `isInfixOf` str)
    ...
    --   it "returns an error" $ do
    --     result <- testProgram "test/programs/bad/example00-CoinFlip__FunctionNamesDefinitionDoesNotMatchDeclaration.lq"
    ...
    --   it "returns an error" $ do
    --     result <- testProgram "test/programs/bad/example08-groverAlgorithm__FunctionNamesDefinitionDoesNotMatchDeclaration.lq"
    --     result `shouldSatisfy` (\str -> "Function name in type definition does not match the function name in declaration" `isInfixOf` str)
    ...
    --   it "returns an error" $ do
    --     testProgram "test/programs/bad/example00-CoinFlip__CorrectNumberOfFunctionArguments_1.lq" `shouldReturn` "OK"
    ...
    --   it "returns an error" $ do
    --     result <- testProgram "test/programs/bad/example00-CoinFlip__IncorrectNumberOfFunctionArguments_1.lq"
    ...
    -- context "when provided with a coinflip program where number of function arguments is incorrect" $ do
    --   it "returns an error" $ do
    --     result <- testProgram "test/programs/bad/example00-CoinFlip__IncorrectNumberOfFunctionArguments_2.lq"
    --     result `shouldSatisfy` (\str -> "Number of function arguments exceeds the number of arguments in signature" `isInfixOf` str)
    ...
    -- context "when provided with a coinflip program where number of function arguments is incorrect" $ do
    --   it "returns an error" $ do
    --     result <- testProgram "test/programs/bad/example00-CoinFlip__IncorrectNumberOfFunctionArguments_3.lq"
    --     result `shouldSatisfy` (\str -> "Number of function arguments exceeds the number of arguments in signature" `isInfixOf` str)
    ...
    --   it "returns an error" $ do
    --     result <- testProgram "test/programs/bad/example07-fourQubitAdder__ControlQubitsNotDistinct.lq"
    ...
    --   it "returns an error" $ do
    --     result <- testProgram "test/programs/bad/example-Bogus__ControlBitsNotDistinct.lq"
    ...
    --   it "returns an error" $ do
    --     result <- testProgram "test/programs/bad/example08-groverAlgorithm__ControlAnTargetQubitsNotDifferent.lq"

...
instance Print Frontend.LambdaQ.Abs.Gate where
  prt i = \case
    ...
    Frontend.LambdaQ.Abs.GateXRoot n -> prPrec i 0 (concatD [doc (showString "ROOT_X"), doc (showString "["), prt 0 n, doc (showString "]")])
    Frontend.LambdaQ.Abs.GateXRootDag n -> prPrec i 0 (concatD [doc (showString "ROOT_X_DAG"), doc (showString "["), prt 0 n, doc (showString "]")])
    Frontend.LambdaQ.Abs.GateYRoot n -> prPrec i 0 (concatD [doc (showString "ROOT_Y"), doc (showString "["), prt 0 n, doc (showString "]")])
    Frontend.LambdaQ.Abs.GateYRootDag n -> prPrec i 0 (concatD [doc (showString "ROOT_Y_DAG"), doc (showString "["), prt 0 n, doc (showString "]")])
    Frontend.LambdaQ.Abs.GateZRoot n -> prPrec i 0 (concatD [doc (showString "ROOT_Z"), doc (showString "["), prt 0 n, doc (showString "]")])
    Frontend.LambdaQ.Abs.GateZRootDag n -> prPrec i 0 (concatD [doc (showString "ROOT_Z_DAG"), doc (showString "["), prt 0 n, doc (showString "]")])
    ...
    Frontend.LambdaQ.Abs.GateSwpRt n -> prPrec i 0 (concatD [doc (showString "ROOT_SWAP"), doc (showString "["), prt 0 n, doc (showString "]")])
    Frontend.LambdaQ.Abs.GateSwpRtDag n -> prPrec i 0 (concatD [doc (showString "ROOT_SWAP_DAG"), doc (showString "["), prt 0 n, doc (showString "]")])
    Frontend.LambdaQ.Abs.GateQft n -> prPrec i 0 (concatD [doc (showString "QFT"), doc (showString "["), prt 0 n, doc (showString "]")])
    Frontend.LambdaQ.Abs.GateQftDag n -> prPrec i 0 (concatD [doc (showString "QFT_DAG"), doc (showString "["), prt 0 n, doc (showString "]")])
    ...
    Frontend.LambdaQ.Abs.GateUknown1Angle gatevar angle -> prPrec i 0 (concatD [prt 0 gatevar, doc (showString "["), prt 0 angle, doc (showString "]")])
    Frontend.LambdaQ.Abs.GateUknownInt gatevar n -> prPrec i 0 (concatD [prt 0 gatevar, doc (showString "["), prt 0 n, doc (showString "]")])
